        <div class="container main_container">
			...
			<div class="frame-container">
					<div class="frame container-fluid">
						...
						<div class="frame-message row">
							...
							<p>En el Lobby Auditorio/Oficina de registro se hará el registro de los asistentes del evento.</p>
						    </div>
						</div>
					</div>
            </div>
			...
			<div class="frame-container">
					<div class="frame container-fluid">
						...
						<div class="frame-message row">
						    <div class="col-lg-12 col-sm-12">
							<p>La ceremonia de inaguración se realizará en el auditorio.</p>
						    </div>
						</div>
					</div>
            </div>
			...
			<div class="frame-container">
					<div class="frame container-fluid">
						...
						<div class="frame-message row">
						    <div class="col-lg-12 col-sm-12">
							<p>La conferencia magistral se realizará en el auditorio.</p>
						    </div>
						</div>
					</div>
			...
			<div class="frame-container">
					<div class="frame container-fluid">
						...
						<div class="frame-message row">
						    <div class="col-lg-12 col-sm-12">
							<p>Los poster registrados se presentarán en el centro de convenciones.</p>
						    </div>
						</div>
					</div>
            </div>
			...
			<div class="frame-container">
					<div class="frame container-fluid">
						...
						<div class="frame-message row">
						    <div class="col-lg-12 col-sm-12">
							<p>El servicio de alimentos estará disponible en el espacio de la explanada del centro de convenciones.</p>
						    </div>
						</div>
					</div>
            </div>
			...
			<div class="frame-container">
					<div class="frame container-fluid">
						...
						<div class="frame-message row">
						    <div class="col-lg-12 col-sm-12">
							<p>Invitamos a los participantes a disfrutar de un agradable evento cultural.</p>
						    </div>
						</div>
					</div>
            </div>
