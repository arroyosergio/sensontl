        <div class="container main_container">
            <div class="container_title feature-head wow fadeInDown animated"  data-wow-animation-name="fadeInDown" style="visibility: visible; animation-name: fadeInDown;" >
                    <h2 class="text-center">Guía para los Autores</h2>				  
            </div>
            <div>
            ...
            <br/>
                ...
                <div class="container_title feature-head wow fadeInDown animated"  data-wow-animation-name="fadeInDown" style="visibility: visible; animation-name: fadeInDown;" >
                    <h3 class="text-center">Plantillas de trabajo</h3>				  
                </div>
				<p>Para descargar la plantilla de trabajo haz click en la imagen <a href=""><i  class="fa  fa-file-word-o fa-2x" aria-hidden="true" ></i></a></p>
                <p>Para descargar la plantilla de trabajo haz click en la imagen <a href=""><i  class="fa  fa-file-word-o fa-2x" aria-hidden="true" ></i></a></p> -->
            </div>
        </div>