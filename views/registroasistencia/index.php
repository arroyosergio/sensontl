				...
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input id="banco" class="form-control" name="banco" type="text"></input>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input id="info-deposito" class="form-control" name="info-deposito" type="text"></input>
					...
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input id="fecha" class="form-control datapicker" name="fecha" type="text"></input>
						</div>
					</div>
				</div>
				<div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
					<div class="form-group">
						...
						<input class="form-control" name="nombre-asistente"></input>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input class="form-control" name="institucion"></input>
					</div>
				</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
					<div class="form-group">
						...
						<input id="nombre-asistente" class="form-control" name="nombre-asistente"></input>
					</div>
					<div class="form-group">
						<label for="">Tipo de asistente:</label>
					...
					<div class="form-group">
						<label for="">Nombre de la instituci&oacute;n educativa:</label>
						<input id="institucion" class="form-control" name="institucion"></input>
					</div>
				</div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><i class="glyphicon glyphicon-remove"></i> Cancelar</button>
