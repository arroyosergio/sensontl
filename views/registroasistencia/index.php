                    ...
                    <div class="panel panel-default">                
                        ...
                        <div class="panel-body">
                            <div class="contened-art">
                                ...
                                <div class="contened-files "  id="contenedor-archivo-art">
                                     <br>
                                    <h4 class="text-primary">Comprabante de pago</h4>
								    <h4 class="text-secondary">Suba el documento de pago escaneado.</h4>
										<div class="row">
											<div class="col-sm-12">
										...
										<div class="row">
											<div class="col-sm-12">
												<h4 class="doc-cargados  text-secondary">Documento cargado</h4>
