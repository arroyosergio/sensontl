		...
		<div class="col-sm-12">
			...
			<div class="panel panel-default">
				...
				<div class="panel-footer">
					<b><em>Nota: </em></b><br><i class="glyphicon glyphicon-ok"> </i>&nbsp;Para descargar las cartas de cesi&oacute;n de derechos y originalidad, as&iacute; como para editar &oacute; subir una nueva versi&oacute;n del art&iacute;culo dar clic en el id correspondiente.<br>
					                          <i class="glyphicon glyphicon-ok"> </i>&nbsp;Para actualizar los datos del registro, de clic en su nombre de usuario, que se encuentra en la parte superior derecha.                      
