<div class="container">
		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Dep&oacute;sitos</h3>
				</div>
				<div class="panel-body">
					<div class="table-responsive">
						<?php echo $this->tblDepositos; ?>
					</div>
				</div>
    ...
    <div id="modal-envio-correo" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
            	<form id="form-envio-correo" action="depositos/enviarCorreo" method="post">
	                <div class="modal-header">
	                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	                ...
	                <div class="modal-body">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<label for=""><b>Agregar los cambios que debe realizar el autor:</b></label>
